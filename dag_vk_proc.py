...
with DAG(dag_id='vk_data_proc',
    ...
    task = KubernetesPodOperator(
        task_id='vk_data_proc_run_script',
        name='vk_proc_run_script',
        namespace='airflow',
        ...
        cmds=[
            "sh", "-c",
            'git clone https://github.com/vgarshin/datalake_scripts && export SPARK_LOCAL_HOSTNAME=localhost && python datalake_scripts/vk_proc.py'
        ],
